...

{
  ...
  'targets': [{
    ...
    'sources': [
      ...
      '<(src_loc)/ui/amount_label.cpp',
      '<(src_loc)/ui/amount_label.h',
      ...
      '<(src_loc)/wallet/wallet_create_invoice.cpp',
      '<(src_loc)/wallet/wallet_create_invoice.h',
      ...
      '<(src_loc)/wallet/wallet_settings.cpp',
      '<(src_loc)/wallet/wallet_settings.h',
      '<(src_loc)/wallet/wallet_top_bar.cpp',
      '<(src_loc)/wallet/wallet_top_bar.h',
      '<(src_loc)/wallet/wallet_update_info.cpp',
      '<(src_loc)/wallet/wallet_update_info.h',
